...
class MTVAE(nn.Module):
    def __init__(self, enc_spatio,enc_temporal,sampling_z, GAT, dec_rec, dec_pre, enc_in, dec_in, d_model=64, dropout=0.0, embed='fixed', freq='t'):
    ...
    def forward(self, all_input, all_target, batch_i, config, epoch, device):
        ...
        return rec_out_cat, pre_out_cat, losses, prob
